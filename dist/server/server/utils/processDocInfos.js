...
function processDocInfos(
  { routesPaths, outDir, baseUrl, siteConfig },
  {
    indexDocs,
    indexBlog,
    indexPages,
  ...
  return routesPaths
    .map((url) => {
      ...
      // ignore files
      if (
        ignoreFiles === null || ignoreFiles === void 0
          ? void 0
          : ignoreFiles.some((reg) => {
        ...
        if (
          blogRouteBasePath.some(
            (basePath) =>
              ...
              isSameOrSubRoute(
                route,
                path_1.default.posix.join(basePath, "tags")
              )
          )
        ) {
