...
function DocusaurusSearchLocalPlugin(context, options) {
  const config = processPluginOptions_1.processPluginOptions(
    options,
    context.siteDir
  );
  ...
  generate_1.generate(config, dir, context.i18n.currentLocale);
  const themePath = path_1.default.resolve(
    __dirname,
    "../../client/client/theme"
  );
...
Object.defineProperty(exports, "validateOptions", {
  enumerable: true,
  get: function () {
    return validateOptions_1.validateOptions;
  },
});
